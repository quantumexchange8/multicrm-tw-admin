...
//    "USDT Protocol Type" => "USDT Protocol Type",
    ...
    "IB Not Found" => "IB Not Found",
    "Referral cannot be themselves" => "Referral cannot be themselves",
    "Referral cannot be same line" => "Referral cannot be same line",
    "New Referral cannot be the same as current" => "New Referral cannot be the same as current",
    "Successfully Transfer" => "Successfully Transfer",
    "Empty" => "Empty",
    "No changes" => "No changes",
    "Invalid New Upline" => "Invalid New Upline",
    "The member’s detail has been edited successfully!" => "The member’s detail has been edited successfully!",
    "Already have this account type" => "Already have this account type",
    "New IB Created" => "New IB Created",
    "The member portal password has been reset successfully" => "The member portal password has been reset successfully",
    "The member has been deleted successfully" => "The member has been deleted successfully",
    "The rebate allocation has been saved!" => "The rebate allocation has been saved!",
    "New rebate allocation has been saved!" => "New rebate allocation has been saved!",
    " has a pending request" => " has a pending request",
    "Error Updating Rebate Payout" => "Error Updating Rebate Payout",
    "Rebate payout approved successfully" => "Rebate payout approved successfully",
    "The new account type has been created successfully!" => "The new account type has been created successfully!",
    "The account type details has been saved successfully!" => "The account type details has been saved successfully!",
    "The account type details has been deleted successfully!" => "The account type details has been deleted successfully!",
    "posted on" => "posted on",
    "No Downline Found" => "No Downline Found",
    " amount cannot be higher than " => " amount cannot be higher than ",
    " amount cannot be lower than " => " amount cannot be lower than ",
    "Successfully refresh group" => "Successfully refresh group",
    "Successfully Update Highlights Images" => "Successfully Update Highlights Images",
    "Insufficient balance" => "Insufficient balance",
    "Successfully Adjusted Cash Wallet" => "Successfully Adjusted Cash Wallet",
    "Successfully Updated Withdrawal Status" => "Successfully Updated Withdrawal Status",
    "Successfully Rejected Withdrawal Request" => "Successfully Rejected Withdrawal Request",
    "Error fetching group data:" => "Error fetching group data:",
    "Error fetching ib downline: " => "Error fetching ib downline: ",
    "Are you sure?" => "Are you sure?",
    "A total of" => "A total of",
    "will be paid to the selected IB!" => "will be paid to the selected IB!",
    "An error occurred while applying the rebate." => "An error occurred while applying the rebate.",
